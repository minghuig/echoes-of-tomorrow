extends Node2D
## Arena backdrop: gradient wash, holographic grid, perimeter frame, corner
## brackets, and slow-drifting data motes. Pure ambience — knows nothing about
## the sim except the arena size handed over at startup.
